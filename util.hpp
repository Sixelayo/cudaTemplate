...
void wdw_info(int mode, int sx, int sy, int fps){
    ...
    ImGui::Text("Mode : "); 
    ImGui::SameLine(); if(ImGui::RadioButton("CPU##rad", &gbl::mode, CPU_MODE)){toggleMode(CPU_MODE);}
    ImGui::SameLine(); if(ImGui::RadioButton("GPU##rad", &gbl::mode, GPU_MODE)){toggleMode(GPU_MODE);}
